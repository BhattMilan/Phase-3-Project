	...
	<%
		...
		if(session==null){
				...
				<table class="table table-dark">
					<thead>
						<tr>
							...
							<c:forEach items="${categoryList}" var="catModel">
								<tr>
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<div id="addCatBtn" class="addCatBtn">
							<button type="button" class="btn btn-success" onclick="window.location='/addCategory'">Add Category</button>
						</div>
					</div>
					<div class="col">
						<div id="deleteCatBtn" class="cls-deleteCatBtn">
							<button type="button" class="btn btn-success" onclick="window.location='/deleteCategory'">Delete Category</button>
						</div>
					</div>
				</div>
			</div>	
