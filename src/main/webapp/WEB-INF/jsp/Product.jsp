...
<body>
	<%
		...
		if(session==null){
			...
			<div id="proTable" class="cls-pro-table" align="center">
				<table class="table">
		...
		<div class="container">
			<div class="row">
					<div class="col">
						<div id="addProBtn" class="cls-addProBtn">
						<button type="button" class="btn btn-success" onclick="window.location='/addProduct'">Add Product</button>
						</div>
					</div>
					<div class="col">
						<div id="deleteProBtn" class="cls-deleteProBtn">
						<button type="button" class="btn btn-success" onclick="window.location='/deleteProduct'">Delete Product</button>
						</div>
					</div>
			</div>
		</div>
