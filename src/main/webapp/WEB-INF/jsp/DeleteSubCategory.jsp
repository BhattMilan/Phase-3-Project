		...
		if(session==null){
			...
			<div id="subCatTable" class="subCatTable">
				<table class="table table-dark">
					...
					<tbody>
							<c:forEach items="${subCatList}" var="subCatModel">
								<tr>
									...
									<td><button type="button" class="btn btn-success" onclick="window.location='/subCatDeleteProcess?id=${subCatModel.subCatID}'">Delete</button></td>
								</tr>
							</c:forEach>
					</tbody>
				</table>
